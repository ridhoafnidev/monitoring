...
<head>
    ...
    <title>Edit User Ketua Prodi</title>
...
$stmti->execute();
  ...
  echo 'setTimeout(function () { swal("Sukses!","Data Ketua Prodi Berhasil Di Edit!","success");})</script>';
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form  method="post" class="form-horizontal">
										...
										<div class="form-group"><label class="col-sm-4 control-label">Nama Ketua Prodi</label>
									...
									<a href="userkaprodi.php" class="btn btn-sm btn-danger">Batal</a></div>
									</div>
                            </form>
                        </div>
                    </div>
