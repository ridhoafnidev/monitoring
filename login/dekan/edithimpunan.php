...
<head>
    ...
    <title>Edit User Himpunan</title>
...
$stmti->execute();
  ...
  echo 'setTimeout(function () { swal("Sukses!","Data Himpunan Berhasil Di Edit!","success");})</script>';
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form  method="post" class="form-horizontal">
									...
									<a href="userhimpunan.php" class="btn btn-sm btn-danger">Batal</a></div>
									</div>
                            </form>
                        </div>
                    </div>
