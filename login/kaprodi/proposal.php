...
if(!isset($_SESSION["username"])){
    ...
    $query = $db->prepare("SELECT * FROM proker, user, proposal, syarat where proker.id_proker=syarat.id_proker and proposal.id_proker=proker.id_proker and proker.oleh=user.username and user.program_studi='$z'");
...
<?php 
    ...
    $query = $db->prepare("SELECT * FROM proker, user, proposal, syarat where syarat.id_proker=proker.id_proker and proposal.id_proker=proker.id_proker and proker.oleh=user.username and user.keterangan='Himpunan' and user.program_studi='$z'");
    $query->execute();
    $data = $query->fetchAll();
    ?>
                <div class="col-lg-12">
