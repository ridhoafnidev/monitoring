...
while($kp =  mysqli_fetch_assoc($query)){
	$kaprodi = $kp['program_studi'];
}
...
$query = mysqli_query($koneksi, 'SELECT * FROM anggaran WHERE tahun_anggaran = "'.$tahun_aktif.'" and program_studi="'.$kaprodi.'" ');
