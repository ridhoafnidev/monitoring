...
if(!isset($_SESSION["username"])){
    ...
    $query = $db->prepare("SELECT * FROM anggaran,user where user.program_studi=anggaran.program_studi and anggaran.keterangan='Himpunan' and anggaran.program_studi='$z' group by user.program_studi");
...
$insert = "insert into anggaran values(' ','$tahun_anggaran', '0','$total_anggaran','Himpunan')";
      ...
      <?php include 'header.php';
		?>
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Data Anggaran <strong>Program Studi : <?php echo "$z"; ?></strong> </h2>
                    <ol class="breadcrumb">
                        <li>
