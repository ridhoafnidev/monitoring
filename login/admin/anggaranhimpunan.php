...
//Row will return false if there was no value
        if ($stmti->rowCount() == 0) {
            //insert new data
            $insert = "insert into anggaran values(' ','$program_studi', '$tahun_anggaran', '$total_anggaran','$total_anggaran','Himpunan')";
$stmti = $db->prepare($insert);
$stmti->setFetchMode(PDO::FETCH_OBJ);
$stmti->execute();
...
echo '<meta http-equiv="Refresh" content="1; URL=anggaranhimpunan.php">';
           ...
           echo '<script type="text/javascript">';
  echo 'setTimeout(function () { swal("Gagal!","Tidak dapat menambahkan anggaran pada program studi yang sama di tahun yang sama!","error");})</script>';
echo '<meta http-equiv="Refresh" content="3; URL=anggaranhimpunan.php">';
        }
    }
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
				...
				foreach ($data as $value) {
					...
					<td>
						<a href="detailanggaran.php?id_anggaran=<?php echo $value ['id_anggaran'] ?>&program_studi=<?php echo $value['program_studi'] ?>" class="btn btn-primary btn-sm btn-icon icon-left">
                            <i class="fa fa-eye"></i>
                            Detail
                        </a>
                        <a href="editanggaran.php?id_anggaran=<?php echo $value ['id_anggaran'] ?>" class="btn btn-default btn-sm btn-icon icon-left">
							<i class="fa fa-pencil"></i>
							Edit
						</a>


						<a href="hapus-anggaran.php?id_anggaran=<?php echo $value['id_anggaran']?>" onclick="return hapus()" class="btn btn-danger btn-sm btn-icon icon-left">
				...
				<?php }
				 ?>
                        ...
                        <div class="ibox-content">
                            <div class="text-left">
                            <a data-toggle="modal" class="btn btn-primary" class="fa fa-plus" href="#modal-form">Tambah Anggaran Himpunan</a>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12">
													<h3 class="m-t-none m-b">Tambah Anggaran Himpunan</h3>
                                        ...
                                        ?>
                                                        ...
                                                        <div class="form-group"><label>Tahun Anggaran </label> <input type="number" name="tahun_anggaran" placeholder="Masukkan Tahun Anggaran" class="form-control" required=""></div>
