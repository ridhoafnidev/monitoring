				...
				foreach ($data as $value) {
					$no++;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edithimpunan.php?id=<?php echo $value ['id'] ?>"
                                                ...
                                                <a href="hapus-himpunan.php?id=<?php echo $value['id']?>&username=<?php echo $value['username']; ?>"
                                ...
                                <div class="ibox-content">
                                    <div class="text-left">
                                        <a data-toggle="modal" class="btn btn-primary" class="fa fa-plus"
                                            href="#modal-form">Tambah Himpunan</a>
                                    </div>
                                    <div id="modal-form" class="modal fade" aria-hidden="true">
                                        ...
                                        ?>
                                                                            ...
                                                                            <option
                                                                                value="<?php echo $value['program_studi'] ?>">
                                                                                <?php echo $value['program_studi'] ?>
                                                                            </option>
                                                                            <?php }
                                        ?>
                                                                        </select>
                                                                ...
                                                                <div class="form-group"><label>Username</label> <input
