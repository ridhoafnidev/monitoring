...
$stmti->execute();
  ...
  echo 'setTimeout(function () { swal("Sukses!","Anggaran Himpunan Berhasil Di Edit!","success");})</script>';
...
<?php $no = 0;
                ...
                <div class="col-lg-12">
                    ...
                    echo "Rp. ".number_format($d, 0, ".", "."); ?>" class="form-control" ></div>
									...
									<a href="anggaranhimpunan.php" class="btn btn-sm btn-danger">Batal</a></div>
									</div>
                            </form>
                        </div>
                    </div>
