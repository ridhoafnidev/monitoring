...
<head>
    ...
    <title>Edit User Sema & Dema</title>
...
$update = "update user set nama='$nama',program_studi='$program_studi',password='$md5',username='$username',status='$status' where id='$id'";
...
$stmti->execute();
  ...
  echo 'setTimeout(function () { swal("Sukses!","User Sema & Dema Berhasil Di Edit!","success");})</script>';
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form  method="post" class="form-horizontal">
										...
										<div class="form-group"><label class="col-sm-4 control-label">Nama Organisasi</label>
											<div class="col-sm-3"><input type="text" name="nama" value="<?php echo $value['nama'] ?>" class="form-control" ></div>
										</div>
                                        <div class="form-group"><label class="col-sm-4 control-label">Program Studi</label>
                                        <div class="col-sm-3">
									...
									<a href="usersemadema.php" class="btn btn-sm btn-danger">Batal</a></div>
									</div>
                            </form>
                        </div>
                    </div>
