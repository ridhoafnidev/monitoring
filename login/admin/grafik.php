		...
		?>
            <div class="row  border-bottom white-bg dashboard-header">
                ...
                <div class="col-lg-12-6">
                    <h2>Selamat Datang, <strong><?php echo $_SESSION["username"] ?>!</strong></h2>
            ...
            <?php               
                $query_per1_sb = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=5 and SB=5 and user='himasi' " );
                $query_per1_sb->execute();
                $data_per1_sb = $query_per1_sb->fetchAll();
            
                $query_per1_b = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=5 and B=4 and user='himasi' ");
                $query_per1_b->execute();
                $data_per1_b = $query_per1_b->fetchAll();
            
                $query_per1_c = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=5 and C=3 and user='himasi' ");
                $query_per1_c->execute();
                $data_per1_c = $query_per1_c->fetchAll();
            
                $query_per1_k = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=5 and K=2 and user='himasi' ");
                $query_per1_k->execute();
                $data_per1_k = $query_per1_k->fetchAll();
            
                $query_per2_sb = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=6 and SB=5 and user='himasi' ");
                $query_per2_sb->execute();
                $data_per2_sb = $query_per2_sb->fetchAll();
            
                $query_per2_b = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=6 and B=4 and user='himasi' ");
                $query_per2_b->execute();
                $data_per2_b = $query_per2_b->fetchAll();
            
                $query_per2_c = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=6 and C=3 and user='himasi' ");
                $query_per2_c->execute();
                $data_per2_c = $query_per2_c->fetchAll();
            
                $query_per2_k = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=6 and K=2 and user='himasi' ");
                $query_per2_k->execute();
                $data_per2_k = $query_per2_k->fetchAll();
            
                $query_per3_sb = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=7 and SB=5 and user='himasi' ");
                $query_per3_sb->execute();
                $data_per3_sb = $query_per3_sb->fetchAll();
            
                $query_per3_b = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=7 and B=4 and user='himasi' ");
                $query_per3_b->execute();
                $data_per3_b = $query_per3_b->fetchAll();
            
                $query_per3_c = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=7 and C=3 and user='himasi' ");
                $query_per3_c->execute();
                $data_per3_c = $query_per3_c->fetchAll();
            
                $query_per3_k = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=7 and K=2 and user='himasi' ");
                $query_per3_k->execute();
                $data_per3_k = $query_per3_k->fetchAll();
            
                $query_per4_sb = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=8 and SB=5 and user='himasi' ");
                $query_per4_sb->execute();
                $data_per4_sb = $query_per4_sb->fetchAll();
            
                $query_per4_b = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=8 and B=4 and user='himasi' ");
                $query_per4_b->execute();
                $data_per4_b = $query_per4_b->fetchAll();
            
                $query_per4_c = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=8 and C=3 and user='himasi' ");
                $query_per4_c->execute();
                $data_per4_c = $query_per4_c->fetchAll();
            
                $query_per4_k = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=8 and K=2 and user='himasi' ");
                $query_per4_k->execute();
                $data_per4_k = $query_per4_k->fetchAll();
            
                $query_per8_sb = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=9 and SB=5 and user='himasi' ");
                $query_per8_sb->execute();
                $data_per8_sb = $query_per8_sb->fetchAll();
            
                $query_per8_b = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=9 and B=4 and user='himasi' ");
                $query_per8_b->execute();
                $data_per8_b = $query_per8_b->fetchAll();
            
                $query_per8_c = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=9 and C=3 and user='himasi' ");
                $query_per8_c->execute();
                $data_per8_c = $query_per8_c->fetchAll();
            
                $query_per8_k = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=9 and K=2 and user='himasi' ");
                $query_per8_k->execute();
                $data_per8_k = $query_per8_k->fetchAll();
            
                $query_per5_sb = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=10 and SB=5 and user='himasi' ");
                $query_per5_sb->execute();
                $data_per5_sb = $query_per5_sb->fetchAll();
            
                $query_per5_b = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=10 and B=4 and user='himasi' ");
                $query_per5_b->execute();
                $data_per5_b = $query_per5_b->fetchAll();
            
                $query_per5_c = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=10 and C=3 and user='himasi' ");
                $query_per5_c->execute();
                $data_per5_c = $query_per5_c->fetchAll();
            
                $query_per5_k = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=10 and K=2  and user='himasi' ");
                $query_per5_k->execute();
                $data_per5_k = $query_per5_k->fetchAll();
            
                $query_per6_sb = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=11 and SB=5  and user='himasi' ");
                $query_per6_sb->execute();
                $data_per6_sb = $query_per6_sb->fetchAll();
            
                $query_per6_b = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=11 and B=4  and user='himasi' ");
                $query_per6_b->execute();
                $data_per6_b = $query_per6_b->fetchAll();
            
                $query_per6_c = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=11 and C=3  and user='himasi' ");
                $query_per6_c->execute();
                $data_per6_c = $query_per6_c->fetchAll();
            
                $query_per6_k = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=11 and K=2  and user='himasi' ");
                $query_per6_k->execute();
                $data_per6_k = $query_per6_k->fetchAll();
            
                $query_per7_sb = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=12 and SB=5  and user='himasi' ");
                $query_per7_sb->execute();
                $data_per7_sb = $query_per7_sb->fetchAll();
            
                $query_per7_b = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=12 and B=4  and user='himasi' ");
                $query_per7_b->execute();
                $data_per7_b = $query_per7_b->fetchAll();
            
                $query_per7_c = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=12 and C=3  and user='himasi' ");
                $query_per7_c->execute();
                $data_per7_c = $query_per7_c->fetchAll();
            
                $query_per7_k = $db->prepare("SELECT * FROM kuesioner_detail where kuesioner_id=12 and K=2  and user='himasi' ");
