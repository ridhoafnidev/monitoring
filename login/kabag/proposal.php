      ...
      <?php include 'header.php';
        ?>
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Data Laporan <strong>Proposal</strong> </h2>
                    <ol class="breadcrumb">
                        <li>
...
<?php 
        $username = $_SESSION['username'];
    $query = $db->prepare("SELECT * FROM proker, user, proposal, syarat where syarat.id_proker=proker.id_proker and proposal.id_proker=proker.id_proker and proker.oleh=user.username and user.keterangan='Himpunan' and proposal.status_proposal='Telah Disetujui'");
    $query->execute();
    $data = $query->fetchAll();
    ?>
                <div class="col-lg-12">
                ...
                <tr>
                    ...
                    <td><?php $d = $value['rancangan_biaya']; echo "Rp. ".number_format($d, 0, ".", "."); ?></td>
                    ...
                    <td>
                    <?php if ($value['status_anggaran']=="Telah Dianggarkan") { ?>
                        ...
                        <a href="prosesproposalcair.php?id_proposal=<?php echo $value ['id_proposal'] ?>" class="btn btn-warning btn-sm btn-icon icon-left">
                            <i class="fa fa-money"></i>
                            Cairkan Dana
                        </a>
                    <?php }elseif($value['status_anggaran']=="Telah Dicairkan"){?>
                        <a href="download.php?file=<?php echo $value ['file_proposal'] ?>" class="btn btn-default btn-sm btn-icon icon-left">
                            <i class="fa fa-eye"></i>
                            Lihat
                            <br>Proposal
                        </a>
                        <a class="btn btn-primary btn-sm btn-icon icon-left">
                            <i class="fa fa-check"></i>
                            Telah
                            <br>Dicairkan
                        </a>
                    <?php }else{ ?>
                        ...
                        <a href="prosesproposal.php?id_proposal=<?php echo $value ['id_proposal'] ?>" class="btn btn-success btn-sm btn-icon icon-left">
                            <i class="fa fa-money"></i>
                            Anggarkan
                        </a>
                        <?php } ?>
