...
include 'db.php';
    ...
    $insert = " update proposal set status_anggaran='Telah Dicairkan' where id_proposal='$id_proposal' ";
    ...
    echo 'setTimeout(function () { swal("Sukses!","Dana Proposal Telah Di Cairkan!","success");})</script>';
