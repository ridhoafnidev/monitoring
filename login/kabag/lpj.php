...
if(!isset($_SESSION["username"])){
    ...
    $query = $db->prepare("SELECT * FROM proker, user, lpj where lpj.id_proker=proker.id_proker and proker.oleh=user.username");
      ...
      <?php include 'header.php';
        ?>
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Data Laporan <strong>LPJ</strong> </h2>
                    <ol class="breadcrumb">
                        <li>
...
<?php 
        $username = $_SESSION['username'];
    $query = $db->prepare("SELECT * FROM proker, user, lpj where lpj.id_proker=proker.id_proker and proker.oleh=user.username and user.keterangan='Himpunan'");
    $query->execute();
    $data = $query->fetchAll();
    ?>
                <div class="col-lg-12">
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="setujuilpj.php?id_proker=<?php echo $value['id_proker'] ?> " onclick="return setujui()">Setujui</a></li>
                                <li><a href="tolaklpj.php?id_proker=<?php echo $value['id_proker'] ?> " onclick="return tolak()">Tolak</a></li>
                            </ul>
                        </div>
