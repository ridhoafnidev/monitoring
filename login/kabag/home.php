                ...
                <div class="widget style1 white-bg">
                    ...
                    <a href="lpj.php">
                        ...
                        <div class="col-xs-8 text-left">
                            ...
                            $query = $db->prepare("SELECT count(*) as lpj from proker,user where proker.oleh=user.username and status_lpj='Menunggu'");
                        ...
                        foreach ($data2 as $value) {
                            $no++;
                        ?> <?php echo $value['lpj'] ?><?php } ?></h2>
                            <span> LPJ Menunggu Persetujuan Anda </span>
                        </div>
                    </div>
                    </a>
                </div>
            ...
            <div class="col-lg-6">
                <div class="widget style1 white-bg">
                    ...
                    <a href="proposal.php">
                        ...
                        $username = $_SESSION['username'];
                            // Buat prepared statement untuk mengambil semua data dari tbBiodata
                            $query = $db->prepare("SELECT count(*) as anggaran FROM proker, user, proposal, syarat where proker.id_proker=syarat.id_proker and proposal.id_proker=proker.id_proker and proker.oleh=user.username and status_anggaran='Menunggu'");
                            // Jalankan perintah SQL
                            $query->execute();
                            // Ambil semua data dan masukkan ke variable $data
                            $data2 = $query->fetchAll();
                        ...
                        foreach ($data2 as $value) {
                        $no++;
                                             ?> <?php echo $value['anggaran'] ?><?php } ?></h2>
                            <span> Proposal Menunggu Dianggarkan </span>
                        </div>
                    </div>
                    </a>
                </div>
