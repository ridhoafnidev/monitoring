                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p><span class="badge badge-<?php
                                                            ...
                                                            ?>"><?php echo $value['status_proker'] ?></span></p>
                                                    </td>
                                                    <td>
                                                        <p><span class="badge badge-<?php
                                                        ...
                                                        ?>"><?php echo $value['status_proposal'] ?></span></p>
                                                                                        </td>
                                                                                        <td>
                                                                                            <p><span class="badge badge-<?php
                                                        $a = $value['status_lpj'];
                                                        ...
                                                        ?>"><?php echo $value['status_lpj'] ?></span></p>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            <div style="width: <?php echo $c ?>%" aria-valuemax="100"
                                                                aria-valuemin="0"
                                                                aria-valuenow="<?php echo $value['progress'] ?>"
                                                                role="progressbar" class="progress-bar progress-bar-<?php
                                                                if($c<40){
                                                                echo "danger";
                                                                }elseif ($c<70){
                                                                echo "warning";
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="detailproker.php?id_proker=<?php echo $value ['id_proker'] ?>"
                                                        ...
                                                        <button type="button" class="btn-sm btn btn-warning"
                                                            ...
                                                            data-content="Tidak dapat mengupload LPJ! Progress tidak memenuhi syarat!">
                                                        ...
                                                        <a href="lpj.php?id_proker=<?php echo $value['id_proker']?>"
