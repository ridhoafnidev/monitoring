...
if(!isset($_SESSION["username"])){
    ...
    $query = $db->prepare("SELECT * FROM semadema, user where semadema.oleh=user.username and semadema.oleh='$nama'");
...
<body>
    <div id="wrapper">
                ...
                <div class="col-lg-4">
                        <div class="widget navy-bg p-lg text-center">
                            ...
                            <h2 class="font-bold no-margins">
                                <?php echo $value['nama_sema']; ?>
                            </h2>
                                <small> Periode <?php echo $value['periode']; ?></small>
                            </div>
                            <img width="150" height="150" src="../images/<?php echo $value['logo_sema']; ?>" class="img-circle circle-border m-b-md" alt="profile">
                            <div>
                ...
                <div class="col-lg-8">
                    <div class="widget navy-bg p-lg text-left">
                        <div class="m-b-md">
                            ...
                            <h1 class="s-xs">Visi</h1>
                            
                            <p><?php echo $value['visi']; ?></p>
                        </div>
                    </div>
                    <div class="widget  navy-bg p-lg text-left">
                        <div class="m-b-md">
        ...
        <div class="row m-t-lg">
            <div class="col-lg-12">
                                <a href="editprofil.php?nama=<?php
                                $nama = $_SESSION['username'];
                                echo $nama ?>" class="btn btn-sm btn-primary">Edit Profil</a></span> 
                </div>
        </div>
        <?php } ?>
        </div>
