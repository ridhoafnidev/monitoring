...
<nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="anggaran.php"><i class="fa fa-money"></i> <span class="nav-label">Anggaran</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="laporan.php"><i class="fa fa-files-o"></i> <span class="nav-label">Laporan</span></a>
                    </li>
                    <li>
