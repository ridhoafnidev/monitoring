...
if(!isset($_SESSION["username"])){
    ...
    $query = $db->prepare("SELECT * FROM proker, user, lpj where lpj.id_proker=proker.id_proker and proker.oleh=user.username and user.username='$username'");
      ...
      <?php include 'header.php';
        ?>
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Laporan <strong>LPJ</strong> </h2>
                    <ol class="breadcrumb">
                        <li>
...
<?php 
    ...
    $query = $db->prepare("SELECT * FROM proker, user, lpj where lpj.id_proker=proker.id_proker and proker.oleh=user.username and user.keterangan='Himpunan' and user.username='$username'");
    $query->execute();
    $data = $query->fetchAll();
    ?>
                <div class="col-lg-12">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#tab-1"> Data LPJ Himpunan</a></li>
