...
if(!isset($_SESSION["username"])){
    ...
    $query = $db->prepare("SELECT * FROM proker, user where user.username=proker.oleh and user.keterangan='Sema & Dema' and user.username='$username'");
...
?>
                        <div class="ibox-content">
                            ...
                            <?php }else{?>
                                <button id="first" class="btn btn-primary">Tambah Program Kerja</button>
                            <?php } ?>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                   ...
                                                   <form role="form" method="post" enctype="multipart/form-data" >
                                                        ...
                                                        <div class="form-group"><label>Rancangan Anggaran Biaya</label> <input type="text" id="rupiah" name="rancangan_biaya" placeholder="Masukkan Rancangan Anggaran Biaya Kegiatan yang Dibutuhkan (Rp)" class="form-control" required=""></div>
...
document.querySelector("#first").addEventListener('click', function(){
  swal("Maaf", "Akun anda tidak aktif lagi!", "error");
});
