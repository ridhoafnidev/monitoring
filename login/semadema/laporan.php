...
if(!isset($_SESSION["username"])){
    ...
    $query = $db->prepare("SELECT * FROM proker,detail_proker, proposal,lpj,user where proposal.id_proker=proker.id_proker and lpj.id_proker=proker.id_proker and proker.id_proker=detail_proker.id_proker and user.username=proker.oleh and user.username='$nama' group by username");
                        ...
                        <div class="ibox-content">
                            ...
                            <i class="fa fa-eye"></i> Lihat LPJ</a>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <a href="download.php?file=<?php echo $value['file'] ?>" class="btn-sm btn-primary btn-icon icon-left">
                            <i class="fa fa-eye"></i> Download File Kwitansi Bantuan (Tahap 1)</a>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <a href="download.php?file=<?php echo $value['file'] ?>" class="btn-sm btn-primary btn-icon icon-left">
                            <i class="fa fa-eye"></i> Download File Kwitansi Bantuan (Tahap 2)</a>
                                    </div>
                                </div>
                            </form>
                        </div>
