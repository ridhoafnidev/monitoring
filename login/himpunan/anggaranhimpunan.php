...
if(!isset($_SESSION["username"])){
    ...
    $query = $db->prepare("SELECT * FROM anggaran, user where anggaran.program_studi=user.program_studi and anggaran.keterangan=user.keterangan and username='$username'");
