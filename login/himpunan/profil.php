...
if(!isset($_SESSION["username"])){
    ...
    $query = $db->prepare("SELECT * FROM himpunan, user where himpunan.oleh=user.username and himpunan.oleh='$nama'");
            ...
            <div class="row">
                <div class="col-lg-4">
                        <div class="widget navy-bg p-lg text-center">
                            ...
                            <img width="150" height="150" src="../images/<?php echo $value['logo_himpunan']; ?>" class="img-circle circle-border m-b-md" alt="profile">
                            <div>
