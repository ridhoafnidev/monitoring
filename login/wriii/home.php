...
<body>
    ...
    $query = $db->prepare("SELECT count(*) as proposal from proker,user where proker.oleh=user.username and status_proposal='Menunggu'");
...
?>
                ...
                foreach ($data2 as $value) {
                    $no++;
                                             ?> <?php echo $value['proposal'] ?><?php } ?></h2>
                            <span> Proposal Menunggu Persetujuan Anda </span>
                        </div>
