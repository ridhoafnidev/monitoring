                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="setujuiproposal.php?id_proker=<?php echo $value['id_proker'] ?> " onclick="return setujui()">Setujui</a></li>
                                <li><a href="tolakproposal.php?id_proker=<?php echo $value['id_proker'] ?> " onclick="return tolak()">Tolak</a></li>
                            </ul>
                        </div>
